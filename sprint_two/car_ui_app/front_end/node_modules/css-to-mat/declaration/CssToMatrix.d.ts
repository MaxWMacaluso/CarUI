...
export declare function parseMat(transform: string | string[]): number[];
export declare function getElementMatrix(el: HTMLElement): number[];
export declare function caculateMatrixDist(matrix: number[], pos: number[]): number[];
...
export declare function parse(transform: string | string[]): MatrixInfo[];
