...
export declare function addGuidelines(totalGuidelines: Guideline[], width: number, height: number, horizontalGuidelines?: number[] | false, verticalGuidelines?: number[] | false): Guideline[];
