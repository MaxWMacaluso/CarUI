...
export declare type MoveableRefType = string | MoveableRefObject | SVGElement | HTMLElement | null | undefined;
export interface MoveableRefObject {
    current?: HTMLElement | SVGElement | null;
}
export interface MoveableOptions extends MoveableDefaultProps, DraggableOptions, DragAreaOptions, OriginDraggableOptions, RotatableOptions, ResizableOptions, ScalableOptions, WarpableOptions, PinchableOptions, GroupableOptions, SnappableOptions, ScrollableOptions, ClippableOptions, RoundableOptions {
}
